...
use App\Relating\Service\Application\RelationRecordActivityApplicationService;
use Symfony\Bundle\FrameworkBundle\Controller\AbstractController;
use Symfony\Component\HttpFoundation\JsonResponse;
use Symfony\Component\HttpFoundation\Request;
use Symfony\Component\Routing\Attribute\Route;

final class RelationRecordActivityController extends AbstractController
{
    #[Route('/relating/activity/record', name: 'relating_activity_record', methods: ['POST'])]
    public function __invoke(Request $request, RelationRecordActivityApplicationService $service): JsonResponse
    {
        $payload = RelationBusinessRequestPayload::from($request);
        $result = $service->recordActivity(new RelationRecordActivityCommand(
