...
use App\Relating\Message\RelationReviewAiSuggestionMessage;
use App\Relating\Service\Application\RelationReviewAiSuggestionApplicationService;
use Symfony\Component\Messenger\Attribute\AsMessageHandler;

#[AsMessageHandler]
final readonly class RelationReviewAiSuggestionMessageHandler
{
    public function __construct(private RelationReviewAiSuggestionApplicationService $service)
    {
    }

    public function __invoke(RelationReviewAiSuggestionMessage $message): void
    {
        $this->service->reviewAiSuggestion(new RelationReviewAiSuggestionCommand(
            ...
            RelationBusinessMessagePayload::string($message->payload, 'decision', 'accepted'),
