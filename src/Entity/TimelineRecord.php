...
final class TimelineRecord extends AbstractRelatingEntity
{
    ...
    public function __construct(string $id, string $targetType, string $targetReference, TimelineRecordKind $eventType, array $payload = [], ?\DateTimeImmutable $occurredAt = null)
    {
        $this->bootEntity($id);
