...
final class RelationTimelineRecordEntity extends RelationAbstractRelatingEntity
{
    ...
    public function __construct(string $id, string $targetType, string $targetReference, RelationTimelineRecordKind $eventType, array $payload = [], ?\DateTimeImmutable $occurredAt = null)
    {
        $this->bootEntity($id);
