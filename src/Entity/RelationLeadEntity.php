...
use App\Relating\Enum\RelationLeadConversionStatus;
...
final class RelationLeadEntity extends RelationAbstractRelatingEntity
{
    ...
    {
        $this->bootEntity($id);
        $this->status = RelationLeadStatus::Captured->value;
        $this->temperature = RelationLeadTemperature::Cold->value;
        $this->conversionStatus = RelationLeadConversionStatus::Pending->value;
    ...
    public function qualify(int $score, RelationLeadTemperature $temperature): void
    {
        $this->score = $this->scoreValue($score, 'RelationLead score');
        $this->temperature = $temperature->value;
        $this->status = RelationLeadStatus::Qualified->value;
        $this->touch();
    }
    ...
    public function disqualify(string $reason): void
    {
        ...
        $this->payload = $payload;
        $this->status = RelationLeadStatus::Disqualified->value;
        $this->touch();
    }
    ...
    public function linkRelationship(string $relationshipReference): void
    {
        ...
        $this->conversionStatus = RelationLeadConversionStatus::LinkedToVendor->value;
        $this->touch();
    }
    ...
    public function markConverted(?string $relationshipReference = null): void
    {
        ...
        $this->status = RelationLeadStatus::Converted->value;
        $this->conversionStatus = RelationLeadConversionStatus::Completed->value;
        $this->touch();
    }
    ...
    public function markDuplicate(string $duplicateReference): void
    {
        ...
        $this->payload = $payload;
        $this->status = RelationLeadStatus::Duplicate->value;
        $this->touch();
    }
